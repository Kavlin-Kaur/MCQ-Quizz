const questions = [
 {
     ...
     optionB: "Colored special sheet",
     optionC: "Color and Style Sheet",
...
/*3*/
 {
     question: "Which type of CSS is generally recommended for designing large web page?",
     optionA: "Inline",
     optionB: "Internal",
     optionC: "External",
     optionD: "None of the above",
...
/*5*/
 ...
 /*7*/
 {
     question: "Can negative value be allowed in padding property?",
     optionA: "Yes",
     optionB: "No",
     optionC: "Depend on property",
     optionD: "None of the above",
...
/*9*/
 ...
 /*10*/
 {
     question: "Which of the following property is used to align text in CSS",
     optionA: "text-align",
     optionB: "text-alignment",
     optionC: "text",
     optionD: "text--position",
     correctOption: "optionA"
 },
]
