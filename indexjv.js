const questions = [
 {
     /*1*/
     question: " JDK stands for _________.",
...
/*2*/
 {
     question: "JRE stands for ___________.",
     optionA: "Java run ecosystem",
     optionB: "JDK runtime Environment",
     optionC: "Java Runtime Environment",
...
/*3*/
 {
     ...
     optionA: "Advanced programming language",
     optionB: "It uses bytecode for execution",
     optionC: "Class compilation",
...
/*5*/
 ...
 /*6*/
 {
     ...
     optionA: "main() method",
     optionB: "The first line of code",
     optionC: "Last line of code",
     optionD: "main class",
     correctOption: "optionA"
 },
 /*7*/
...
/*9*/
 {
     ...
     optionA: "Instance Variable",
     optionB: "Local Variable",
     optionC: "Static Variable",
     optionD: "All of the above",
 ...
 /*10*/
 {
     ...
     optionA: "It is converting type of a variable from one type to another",
     optionB: "Casting variable to the class",
     optionC: "Creating a new variable",
     optionD: "All of these",
     correctOption: "optionA"
 },
]
